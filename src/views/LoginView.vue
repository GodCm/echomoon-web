...
import { Moon, Mail, Lock, ArrowLeft, Loader2 } from 'lucide-vue-next'
    ...
    <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden">
      ...
      <div class="relative z-10 flex flex-col justify-center px-16">
        ...
        <h1 class="text-4xl font-bold mb-6">
          Welcome Back
          <br />
          <span class="text-gradient">to Your Journey</span>
        </h1>
        
        <p class="text-text-secondary text-lg max-w-md">
          Continue your conversations and find the closure you're seeking. Every dialogue brings you closer to understanding.
        </p>
      </div>
    </div>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8">
      <div class="w-full max-w-md">
        ...
        <div class="glass-card p-8">
          ...
          <p class="text-text-secondary mb-8">Enter your details to access your account</p>

          <!-- Social Login Buttons -->
          <div class="space-y-3 mb-8">
            <button @click="handleGoogleLogin" class="w-full flex items-center justify-center gap-3 bg-white text-gray-800 rounded-xl px-4 py-3 font-medium hover:bg-gray-100 transition-colors">
            ...
            <button @click="handleAppleLogin" class="w-full flex items-center justify-center gap-3 bg-white text-gray-800 rounded-xl px-4 py-3 font-medium hover:bg-gray-100 transition-colors">
          ...
          <div class="relative mb-8">
            ...
            <div class="relative flex justify-center text-sm">
              <span class="px-4 bg-background-lighter text-text-muted">or continue with email</span>
            </div>
          </div>
          ...
          <p class="text-center mt-6 text-text-secondary">
            ...
            <RouterLink to="/register" class="text-primary hover:text-primary-light transition-colors">
              Sign up
            </RouterLink>
          </p>
        </div>
